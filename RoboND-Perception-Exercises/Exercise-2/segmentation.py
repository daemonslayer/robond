...
def pcl_callback(pcl_msg):
    ...
    # TODO: Convert ROS msg to PCL data (XYZRGB)
    ...
    # TODO: Convert the xyzrgb cloud to only xyz since k-d tree only needs xyz
...
if __name__ == '__main__':
    ...
    # TODO: Initialization ROS node called 'clustering'
